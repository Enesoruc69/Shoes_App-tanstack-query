  ...
  return (
    <div>
      ...
      <div>
        ...
        {/* 
         * API'dan gelen html içeriğini react'ta ekrana basmak için
          "dangerouslySetInnerHTML" propunu kullanırız 
          
         * xss kütüphanesi ile html içindeki, zararlı olabilecek 
          scriptleri bozarak bu yöntemi kullandığımızda bir tehlike kalmaz
        */}
        <p
